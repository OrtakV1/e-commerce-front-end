...
const DetailsPage = () => {
  ...
  const matchingProduct = products.find(
    (product) => product.UrunKartiID === targetId
  );
  console.log(matchingProduct.Aciklama.__cdata);
  ...
  return (
    <div ref={pageTopRef}>
        ...
        <div className="container">
          <div className="row justify-content-between align-items-center">
            <div className="col-lg-5 col-sm-12 p-3">
              <div className="img-wrap">
                ...
                <div className="text-center d-flex justify-content-center mt-3">
                  {matchingProduct.Resimler.Resim.slice(0, 4).map(
                    (resim, index) => (
                      <img
                        key={index}
                        width={65}
            ...
            <div className="col-lg-6">
              <h2 className="section-title">{matchingProduct.UrunAdi}</h2>
              <p>
                Stok Kodu: ({matchingProduct.UrunSecenek.Secenek[0].StokKodu})
              </p>
              <div className="row my-3">
                ...
                <div className="col-12 col-md-12 col-sm-12">
                  <div className="feature">
                    {matchingProduct.UrunSecenek.Secenek.map(
                      (secenek, index) => (
                        <button
                          key={index}
                          style={{
                            ...
                            background:
                              secenek.SatisFiyati === value ? 'gray' : 'white',
                          }}
      ...
      <ProductComment matchingProduct={matchingProduct} />
