    ...
    return (
        <div className="justify-content-center text-center mt-5"
            ...
            <Button label="Vintage"
                    style={{background: selectedButton === "Vintage" ? "gray" : '#3b5d50', color: "white", borderRadius:"30px"}}
                    text raised onClick={() => handleButtonClick("Vintage")}/>
            <Button label="İskandinav"
                    style={{background: selectedButton === "İskandinav" ? "gray" : '#3b5d50', color: "white",borderRadius:"30px"}}
                    text raised onClick={() => handleButtonClick("İskandinav")} />
            <Button label="Bohem"
                    style={{background: selectedButton === "Bohem" ? "gray" : '#3b5d50', color: "white",borderRadius:"30px"}}
                    text raised onClick={() => handleButtonClick("Bohem")}/>
            <Button label="Lazer Kesim"
                    style={{background: selectedButton === "Lazer Kesim" ? "gray" : '#3b5d50', color: "white",borderRadius:"30px"}}
